...
class ServiceLocator {
  ...
  static void initialize() {
    ...
    locator.register<InstallationService>(InstallationService(preferencesService));
    
    final installationService = locator.get<InstallationService>();
    locator.register<LauncherService>(LauncherService(preferencesService, installationService));
    
    // Register the main update service
    locator.register<UpdateService>(UpdateService.withServices(
